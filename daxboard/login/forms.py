...
class LoginForm(forms.Form):
    dynamics_fo_url = forms.URLField(max_length=256, label='D365 FO URL', required=False, widget=forms.TextInput(attrs={'class': "form-control", 'placeholder': 'D36r URL address'}))
